...
public class MySkillsLocators {
    ...
    public static String skillName = "//div[@id='tblSkillSet']/table/tbody/tr/td/a[text()='skill']";
    public static String modalTitle = "//h4[text()='Manage Skills']";


    public static String genericButton = "//button[@id='ids']";
    public static String tableRow = "//div[@id='tblSkillSet']/table/tbody/tr";
