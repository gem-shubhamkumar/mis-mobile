    ...
    public String verifyProjectAndGoalDescription(String projName,String desc){
        ...
        for(int i=1;i<=sizeOfTabItems;i++){
            if($(By.xpath("//table[@id='tblSelfGoalList']/tbody/tr["+i+"]/td[1]")).getText().equals("Delivery")){
                ...
                $(By.xpath("//table[@id='tblSelfGoalList']/tbody/tr["+i+"]/td[1]")).click();
                System.out.println( $(By.xpath("//table[@id='tblSelfGoalList']/tbody/tr[@class='child']/td/ul/li[1]/span[2]")).getText());
                System.out.println( $(By.xpath("//table[@id='tblSelfGoalList']/tbody/tr[@class='child']/td/ul/li[2]/span[2]")).getText());
                if( $(By.xpath("//table[@id='tblSelfGoalList']/tbody/tr[@class='child']/td/ul/li[1]/span[2]")).getText().equals(projName) &&  $(By.xpath("//table[@id='tblSelfGoalList']/tbody/tr[@class='child']/td/ul/li[2]/span[2]")).getText().equals(desc) ){
                    return "//table[@id='tblSelfGoalList']/tbody/tr[@class='child']/td/ul/li[4]/span[2]/div/button";
                }
            }
        }
