...
public class LeaveManagementImplementation extends PageObject {
    ...
    public void clickOn(String btnName) {
        ...
        if (elementFacade.isEnabled()) {
            Assert.assertTrue("Verified button: " + tab + "is present on screen",true);
            elementFacade.click();
        } else {
            Assert.fail("Unable to find button");
        }
    }
